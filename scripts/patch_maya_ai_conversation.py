...
screen.write_text(r'''import 'dart:async';
...
print('Approved Maya design applied: premium Free Talk home, text + voice conversation, live microphone, spoken Maya replies, Hindi/Hinglish→English coaching, corrections, adaptive expression, emotional TTS, daily AI usage, safe conversation and summary.')